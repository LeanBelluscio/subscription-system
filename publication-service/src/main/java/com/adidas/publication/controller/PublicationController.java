...
import com.adidas.publication.errorhandling.ObjectNotFoundException;
...
import com.adidas.publication.service.impl.ResApiComsumer;
...
public class PublicationController {
	...
	String newsletterSubscription(@Valid @RequestBody SubscriptionRequest body) throws SubscriptionServiceErrorException, IOException, Exception{
		logger.info("Creatign new Subscription");
		return this.subscriptionServiceConsumer.subscribe(body);
	}
